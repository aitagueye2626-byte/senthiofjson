    ...
    <div id="pageConnexion">
      ...
      <div class="aita">
        ...
        <div class="aita-gauche">
          ...
          <img src="logo.png" alt="Logo SenThiof-JSON" class="aita-image" />

          <div class="aita-nom">SenThiof-JSON</div>
        ...
        <div class="aita-droite">
          ...
          <div class="logo-zone">
            ...
            <div class="nom-app">SenThiof-JSON</div>
          </div>
          ...
          <div id="formuInscription" class="cache">
            ...
            <p class="sous-titre-connexion">Rejoignez SenThiof-JSON dès maintenant !</p>
